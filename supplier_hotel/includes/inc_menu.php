...
$modules['02_1_cat_and_goods']['01_goods_list_pass1']       = 'goods.php?act=list&supplier_status=1';         // 商品列表
$modules['02_1_cat_and_goods']['01_goods_list_pass2']       = 'goods.php?act=list&supplier_status=0';         // 商品列表
$modules['02_1_cat_and_goods']['01_goods_list_pass3']       = 'goods.php?act=list&supplier_status=-1';         // 商品列表
$modules['02_1_cat_and_goods']['03_rooms_add']			  = 'goods.php?act=add';          // 添加商品
$modules['02_1_cat_and_goods']['05_comment_manage']		  = 'comment_manage.php?act=list'; //评论
...
$modules['06_hotel_manage']['09_base']               	= 	'supplier.php?act=supplier_base_info';
$modules['06_hotel_manage']['10_pic']               	= 	'hotels_gallery.php';
$modules['06_hotel_manage']['11_attr']         =    'hotels_attribute.php?act=hotel_attribute_view&type=search';
// $modules['06_hotel_manage']['02_menu']               	= 	'navigator.php?act=list';
// $modules['06_hotel_manage']['03_guanggao']             = 	'flashplay.php?act=list';
// $modules['06_hotel_manage']['04_article']              = 	'article.php?act=list';
// $modules['06_hotel_manage']['05_header']               = 	'shop_header.php?act=list_edit';
// $modules['06_hotel_manage']['06_templates']            = 	'template.php?act=list';
// $modules['06_hotel_manage']['07_street']				= 	'street.php?act=info';
// $modules['06_hotel_manage']['08_shipping_list']           = 'shipping.php?act=list';
