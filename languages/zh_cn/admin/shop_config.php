...
$_LANG['cfg_name']['recom_rank'] = '参与分成的金币下限';
...
$_LANG['cfg_name']['comment_pay_points'] = '评价可获得金币';
$_LANG['cfg_name']['shaidan_pre_num'] = '晒单前多少位可获得金币';
$_LANG['cfg_desc']['shaidan_pre_num'] = '如果评论不需要审核，则前X位晒单的买家可获得金币。如果评论需要审核，则前X位审核通过的买家可获得金币0表示不限制数量';
$_LANG['cfg_name']['shaidan_img_num'] = '晒单图片数量大于多少可获得金币';
$_LANG['cfg_name']['shaidan_pay_points'] = '晒单可获得金币数';
