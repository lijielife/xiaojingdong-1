...
if ($_REQUEST['act']== 'list')
{
    ...
    $smarty->assign('ur_here', '图片管理');
    $smarty->assign('action_link_special', array('text' => $_LANG['add_new'], 'href' => 'flashplay.php?act=add&supplier_id='.$supplier_id));
...
elseif($_REQUEST['act']== 'del')
{
    ...
    {
        $links[] = array('text' => $_LANG['go_url'], 'href' => 'flashplay.php?act=list&supplier_id='.$supplier_id);
        die('abc');
    ...
    ecs_header("Location: flashplay.php?act=list&supplier_id=$supplier_id\n");
    exit;
}
elseif ($_REQUEST['act'] == 'add')
{
    ...
    if (empty($_POST['step']))
    {
        ...
        $smarty->assign('action_link', array('text' => $_LANG['go_url'], 'href' => 'flashplay.php?act=list&supplier_id='.$supplier_id));
        $smarty->assign('rt', $rt);
    ...
    elseif ($_POST['step'] == 2)
    {
        ...
        {
            $links[] = array('text' => $_LANG['add_new'], 'href' => 'flashplay.php?act=add&supplier_id='.$supplier_id);
