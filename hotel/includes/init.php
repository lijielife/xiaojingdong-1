...
/* 取得当前ecshop所在的根目录 */
if(!defined('HOTEL_ADMIN_PATH'))
{
    define('HOTEL_ADMIN_PATH','hotel');
}
define('ROOT_PATH', str_replace(HOTEL_ADMIN_PATH . '/includes/init.php', '', str_replace('\\', '/', __FILE__)));
...
require(ROOT_PATH . HOTEL_ADMIN_PATH . '/includes/lib_main.php');
require(ROOT_PATH . HOTEL_ADMIN_PATH . '/includes/cls_exchange.php');
...
$smarty->template_dir  = ROOT_PATH . HOTEL_ADMIN_PATH . '/templates';
...
if ($_REQUEST['act'] != 'login' && $_REQUEST['act'] != 'signin' &&
    $_REQUEST['act'] != 'forget_pwd' && $_REQUEST['act'] != 'reset_pwd' && $_REQUEST['act'] != 'check_order')
{
    $admin_path = preg_replace('/:\d+/', '', $ecs->url()) . HOTEL_ADMIN_PATH;
